...
function checkTerms(event) {
    if (!elTerms.checked) {
    elTermsHint.innerHTML = 'You must accept the terms.';
    event.preventDefault();
    }
    }

    elForm.addEventListener('submit', checkTerms, false);
    elSelectPackage.addEventListener('change', packageHint, false); // why don't these need the 'e' in the parentheses